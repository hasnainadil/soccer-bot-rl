...
env = Game_env(screen=screen, fps=160)
print(env.play_step((const.Direction.FORWARD, const.Direction.STOP_ROTATION),(const.Direction.STOP_TOWARDS, const.Direction.STOP_ROTATION)))
# while True:
